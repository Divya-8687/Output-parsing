...
openai.organization = "org-Qva6gjxKlpeRu8VZR8j3pdqU"
...
class GPT:
    ...
    def query_gpt(self,prompt):
        response = openai.ChatCompletion.create(model="gpt-3.5-turbo-16k", messages=prompt,        temperature = 1, max_tokens = 500)
        print(response)
